...
import { Crafting } from './wallet/crafting';
        ...
        <main>
            <div className="App" style={{display:"inline-block", width:"100%"}}>                
                <Switch>
                  ...
                  <Route path="/game/crafting/:asset" render={(props)=>(<Crafting {...props} {...myprops}/>)} />
                  <Route path="/game/crafting" render={(props)=>(<Crafting {...props} {...myprops}/>)} />
